...
struct ChannelMediaOptions {
  ...
  */
  ...
  Optional<const char*> token;
   /**
   * The string defined by user, with the terminating null character,
   * which cannot be longer than 128 bytes.
   * It is invalid to set identity as a null pointer or a empty string.
   */
  Optional<const char*> identity;
  /**
...
class IRtcEngine : public agora::base::IEngineBase {
 public:
   ...
   * - < 0: Failure.
   */
  virtual int joinChannelByAppId(const char* appId, const char* channelId, const char* info,
                                 uid_t uid) = 0;
   ...
   * - < 0: Failure.
   */
  virtual int joinChannelByAppId(const char* appId, const char* channelId, uid_t uid,
                                 const ChannelMediaOptions& options) = 0;
...
///@endcond
  ...
  */
   ...
   * - < 0: Failure.
   */
  virtual int setDualStreamMode(VIDEO_SOURCE_TYPE sourceType, SIMULCAST_STREAM_MODE mode,
