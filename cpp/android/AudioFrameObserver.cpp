...
namespace agora {
    ...
    void AudioFrameObserver::setNativeHandler(long long engineHandle) {
    ...
    bool AudioFrameObserver::onPublishAudioFrame(const char* channelId, AudioFrame& audioFrame) {
        return true;
    }
    ...
    media::IAudioFrameObserverBase::AudioParams AudioFrameObserver::getPublishAudioParams() {
        return media::IAudioFrameObserverBase::AudioParams();
    }
